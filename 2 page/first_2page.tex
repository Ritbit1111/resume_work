...
%		on the web app powered by Django 
...
{\customcvproject{PV module field survey in Leh}{June 2019 }
	{\begin{itemize}
			\item Participated in PV module survey with 2 others to get performance degradation and plant installation inspection 
%			12kWp
			\item Surveyed 88 modules at 3 sites to carry out examination like module and string level I-V characterization, IR thermography to detect hotspots and visual imaging to capture cracks on the cells
			\item Calculated average performance degradation rate per year to be  1.42\%, 3.32\% and 3.97\%
		\end{itemize}
	}
}
{\customcvproject{Teaching Assistant}{Jul 2019 to Nov 2019}
	{\begin{itemize}
...
{\customcvproject{Degradation rate determination of solar power plants | Dual Degree Project}{July 2019 - Present}
   {\begin{itemize}
    ...
    \item Processed module datasheet values to extract the 5 parameters and then solved ideal diode equation.
