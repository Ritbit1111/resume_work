...
%  		\item Designed UX and UI for inside traders to access TCA report easily for them and their clients
		...
		\item Implemented login authorization, dynamic forms for single day and multiple day TCA query based on Date, Account ID, Portfolio and Instrument and downloadable link to summarize csv file on Django framework
%		on the web app powered by Django 
		...
		\item Reviewed and reengineered the code base for plotting transaction execution plots using python
