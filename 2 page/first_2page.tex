...
%		\item Django framework, login, singleTCA, multipleday TCA, downloadable link to summary as a csv file, date, account, portfolio, instrument -- This is a keyword line
		\item Implemented login authorization, dynamic forms for single day and multiple day TCA query based on date, account ID, portfolio and instrument and download link to summary as csv file on Django framework
