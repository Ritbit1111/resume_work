...
{\customcvproject{Teaching Assistant}{Jul 2019 to Nov 2019}
	{\begin{itemize}
		\item Developed an online portal for students to access personalized random failure data of devices and predict the nature of failure
...
{\begin{itemize}
  ...
  \item Concluded that tilt angle should be equal to the latitude angle and solar panel should be facing south in northern hemisphere and vice versa
  \item Observed for equatorial regions the optimal azimuthal angle changed seasonally and 2 axis tracking shows maximum output 
\end{itemize}
}
