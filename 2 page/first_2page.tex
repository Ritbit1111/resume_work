...
{\customcvproject{Edelweiss Securities Limited}{May 2018 - July 2018}
  {\begin{itemize}
		...
		\item Django framework, login, singleTCA, multipleday TCA, downloadable link to summary as a csv file, date, account, portfolio, instrument
...
\begin{itemize}
	\item Solar System Design, Finance, Reliability of devices, Data Structure and Algorithm
\end{itemize}
