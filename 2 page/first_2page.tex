...
{\customcvproject{Edelweiss Securities Limited}{May 2018 - July 2018}
  ...
  {\begin{itemize}
		...
		\item Django framework, login, singleTCA, multipleday TCA, downloadable link to summary as a csv file
		\item Two kinds of logging namely Logging also done for issues
	\end{itemize}
  }
	WINTER:
	  {\begin{itemize}
			\item Studied and reengineered the code base for plotting daily market-price vs time curve on plotly
			\item Added features to the transaction execution plots like embedding the volume traded, ticks for different side, hover for details and much more to help traders compare their performance with the market
			\item Reengineered code base that fueled improvements to productivity, efficiency, u
		\end{itemize}
	}
}
