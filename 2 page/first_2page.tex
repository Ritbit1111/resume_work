...
\section{WORK EXPERIENCE AND SURVEY}
{\customcvproject{Edelweiss Securities Limited}{May 2018 - July 2018}
  {\begin{itemize}
  		\item Worked on Transaction Cost Analysis (TCA) report design that helped traders get actionable insights to enhance and synchronize trading related execution quality, compliance and management.
  		\item Designed UX and UI for inside traders to access TCA report easily for them and their clients
		\item Django framework, login, singleTCA, multipleday TCA, downloadable link to summary as a csv file, date, account, portfolio, instrument -- This is a keyword line
		\item Added login authorization, single day and multiple day TCA form on the web app powered by Django 
		\item Constructed 2 kinds of logging, one for Django related requests and other for data issues
			\item Studied and reengineered the code base for plotting daily market-price vs time curve on plotly
			\item Added features to the transaction execution plots like embedding the volume traded, hover for instant details and much more to help traders compare their performance with the market
		\end{itemize}
	}
}
{\customcvproject{Leh Solar Power Plant Survey}{June 2019 }
	{\begin{itemize}
			...
			\item Survey of 4 solar plants of 12kWp units consisting of I-V sweeps, IR imaging of cells
			\item Calculated the degradation rate to be ............
		\end{itemize}
	}
}
{\customcvproject{Teaching Assistant of PG course}{Jul 2019 to Nov 2019}
	{\begin{itemize}
		\item Generated artificial random data for various distributions with varying parameters
		\item Develop online portal for students to access personalized random failure data of devices and predict the nature of failure
	\end{itemize}
}
}
...
{\customcvproject{Degradation rate of solar power plants | Dual Degree Project}{July 2019 - Present}
   {\begin{itemize}
   	\item To create models for solar cells and find the dependency of parameters on the degradation rate
    \item Implemented single diode model with five parameters for solar cell on python 
    \item Processed module datasheet values to extract the 5 parameters and then solved diode equation.
...
\begin{itemize}
	\item Solar System Design, Finance, Algorithmic trading, Reliability of devices, Data Structure and Algorithm
\end{itemize}
